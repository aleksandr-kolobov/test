...
public class Main {
    ...
    private static final String DATA_FILE = "E:/IdeaProjects/java_basics/ExceptionsDebuggingAndTesting/" +
    ...
    public static void main(String[] args) {
        ...
        logger2 = LogManager.getLogger("input");
        ...
        for (; ; ) {
            try {
                ...
                logger1.info("Нашли станцию отправления: " + from.getName());
                Station to = takeStation("Введите станцию назначения:");
                logger1.info("Нашли станцию назначения : " + to.getName());
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            logger2.info("Такая станция не найдена: " + line);
